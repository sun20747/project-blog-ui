...
import { unstable_createMuiStrictModeTheme as createMuiTheme,ThemeProvider} from "@mui/material";  
...
export default function Root({ children }) {
    ...
    useEffect(() => {
      const localStorageDarkMode =  localStorage.getItem("darkMode") == "true" ? true : false;
